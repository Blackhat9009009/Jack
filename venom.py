...
TOKEN = '7276813865:AAF1QNMBLCCQxoePGt_xRBZKaW44fyrZlVg'
...
FORWARD_CHANNEL_ID = -1002170984320
CHANNEL_ID = -1002170984320
error_channel_id = -1002170984320
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: @jack_sparrow_offical_0", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Contact admin https://t.me/jack_sparrow_offical_0*", parse_mode='Markdown')
    else:
